...
const approveVendor = async (req, res) => {
  try {
    ...
    // ======================================
    // CLEAN MESSAGE (SWIGGY STYLE)
    // ======================================
    const message = `Hi ${vendor.name}, your vendor account has been approved 🎉\n🕒 ${time}`;
...
const rejectVendor = async (req, res) => {
  try {
    ...
    // CLEAN MESSAGE (SWIGGY STYLE)
    // ======================================
    const message = `Hi ${vendor.name}, your vendor request has been rejected ❌\n🕒 ${time}`;
